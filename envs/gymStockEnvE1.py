...
VOLUME     = 1	    # The value is scaled to be < 1000.
ADJCLOSE	   = 2
RSI	       = 3
VR         = 4
EMA5       = 5
...
CCI	       = 10
ADX        = 11
POSITION   = 12 # Position Stock quantity
STARTDATA  = 1
ENDDATA    = 12
STATE_BUFFER_LEN = 13
DATA_BUFFER_LEN = 11

class StockEnvE1(gym.Env):
    """A stock trading environment based on OpenAI gym"""
    metadata = {'render.modes': ['human']}

    def __init__(self, df,day = 0,seedIn=None):
